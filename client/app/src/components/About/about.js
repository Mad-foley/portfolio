                        ...
                        <div className="col-lg-6 ps-lg-5">
                            <div className="about-text">
                                ...
                                <div className="btn-bar pt-4">
                                    <a rel="noopener noreferrer" target="_blank" href="https://github.com/Mad-foley" className="px-btn px-btn-theme me-4">GitHub <i className="fab fa-github"></i></a>
                                    <a rel="noopener noreferrer" target="_blank" href="https://drive.google.com/file/d/1-q3DZ2wAQ0y6SD15U0U2FSISz8l-eYfl/view?usp=sharing" className="px-btn px-btn-dark" to="portfolio">Resume</a>
                                </div>
                            </div>
                        </div>
                    </div>
