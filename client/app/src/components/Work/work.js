                                ...
                                <div className="portfolio-text">
                                    ...
                                    Tools: FastAPI, React, Docker, PostgreSQL, CSS, HTML, Tailwind-CSS
                                     ...
                                     <div className="btn-bar">
                                        <a rel="noopener noreferrer" target="_blank" href="https://github.com/Mad-foley/birdinglogs" className="px-btn px-btn-theme" >View Code <i className="fab fa-github"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="row gx-3 pb-3 mb-5 pb-lg-3 mb-lg-3 gy-4 portfolio-box justify-content-around align-items-center">
                            ...
                            <div className="col-md-6 col-lg-5">
                                <div className="portfolio-text">
                                    ...
                                    <div className="btn-bar">
                                        <a rel="noopener noreferrer" target="_blank" href="https://github.com/Mad-foley/the-cave" className="px-btn px-btn-theme">View Code <i className="fab fa-github"></i></a>
                                        <a rel="noopener noreferrer" target="_blank" href="https://team-07-the-fermenters.gitlab.io/module3-project-gamma" className="px-btn px-btn-dark ml-3">View Site</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="row gx-3 pb-3 mb-5 pb-lg-3 mb-lg-3 gy-4 portfolio-box justify-content-around align-items-center flex-row-reverse">
                            ...
                            <div className="col-md-6 col-lg-5">
                                <div className="portfolio-text">
                                    ...
                                    <div className="btn-bar">
                                        <a rel="noopener noreferrer" target="_blank" href="https://github.com/Mad-foley/CarCar" className="px-btn px-btn-theme" >View Code <i className="fab fa-github"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="row gx-3 pb-3 mb-5 pb-lg-3 mb-lg-3 gy-4 portfolio-box justify-content-around align-items-center">
                            ...
                            <div className="col-md-6 col-lg-5">
                                <div className="portfolio-text">
                                    ...
                                    <div className="btn-bar">
                                        <a rel="noopener noreferrer" target="_blank" href="https://github.com/Mad-foley/flashcards" className="px-btn px-btn-theme" >View Code <i className="fab fa-github"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
