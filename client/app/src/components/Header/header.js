                ...
                <nav className="navbar header-nav navbar-expand-lg one-page-nav">
                    <div className="container">
                        ...
                        <span className="flex gap mr-1">
                            ...
                            <a rel="noopener noreferrer" target="_blank" className="py-3" href='https://github.com/Mad-foley'><i className="fab fa-github fa-2x"></i></a>
                            <a rel="noopener noreferrer" target="_blank" className="py-3 px-3" href='https://www.linkedin.com/in/mad-foley/'><i className="fab fa-linkedin fa-2x fill-blue"></i></a>
                        </span>
                    </div>
                </nav>
            </header>
